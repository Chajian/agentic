 ...
 */
export interface QwenAdapterConfig extends LLMAdapterConfig {
  /** Embedding model (defaults to text-embedding-v2) */
...
export class QwenAdapter implements LLMAdapter {
  ...
  constructor(config: QwenAdapterConfig) {
    ...
    this.embeddingModel = config.embeddingModel ?? 'text-embedding-v2';
